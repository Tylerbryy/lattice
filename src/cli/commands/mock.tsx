...
const mockAgentOutputs: AgentOutput[] = [
  {
    ...
    analyses: [
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "D",
        gradeNote: "Negative margin at current price",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "D+",
        gradeNote: "Euphoric pricing, overvalued",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "D",
        gradeNote: "Trading 68% above fair value",
    ...
    analyses: [
      {
        ...
        signal: "bullish",
        grade: "A-",
        gradeNote: "Wide moat, strong ecosystem",
      ...
      },
      {
        ...
        signal: "bullish",
        grade: "A",
        gradeNote: "Exceptional FCF generation",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "B-",
        gradeNote: "Good ops, low insider ownership",
    ...
    analyses: [
      {
        ...
        signal: "bearish",
        grade: "C-",
        gradeNote: "Analyst conflicts present",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "C",
        gradeNote: "Herd behavior evident",
    ...
    analyses: [
      {
        ...
        signal: "bearish",
        grade: "C-",
        gradeNote: "China decline ignored by bulls",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "C",
        gradeNote: "Anchoring to past success",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "C",
        gradeNote: "Safe stock perception",
    ...
    analyses: [
      {
        ...
        signal: "bearish",
        grade: "C-",
        gradeNote: "Multiple biases combining",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "C",
        gradeNote: "Price vs quality disconnect",
    ...
    analyses: [
      {
        ...
        signal: "bearish",
        grade: "D+",
        gradeNote: "Fails inversion test",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "D",
        gradeNote: "High P/E historically underperforms",
    ...
    analyses: [
      {
        ...
        signal: "bearish",
        grade: "D+",
        gradeNote: "EV below current price",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "D",
        gradeNote: "Poor compounding setup",
    ...
    analyses: [
      {
        ...
        signal: "bearish",
        grade: "C-",
        gradeNote: "Better alternatives exist",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "C",
        gradeNote: "Watch for holding bias",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "C+",
        gradeNote: "Disruption risk manageable",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "B-",
        gradeNote: "No scarcity concerns",
    ...
    analyses: [
      {
        ...
        signal: "bullish",
        grade: "A-",
        gradeNote: "Strong ecosystem flywheel",
      ...
      },
      {
        ...
        signal: "bullish",
        grade: "A",
        gradeNote: "Massive installed base",
      ...
      },
      {
        ...
        signal: "neutral",
        grade: "B",
        gradeNote: "Scale benefits plateauing",
    ...
    analyses: [
      {
        ...
        signal: "neutral",
        grade: "B-",
        gradeNote: "Clear model, uncertain catalysts",
      ...
      },
      {
        ...
        signal: "bearish",
        grade: "C",
        gradeNote: "Quality passes, valuation fails",
